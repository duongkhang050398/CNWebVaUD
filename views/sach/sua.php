		...
		<form action="index.php?action=sach_sua_xuly" method="post">
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="HinhAnh" name="HinhAnh" value="<?php echo $sach['HinhAnh']; ?>" placeholder="" />
				</div>
			</div>
			<div class="form-group">
				<label for="MoTa">Mô tả</label>
				<textarea class="form-control" id="MoTa" name="MoTa" placeholder=""><?php echo $sach['MoTa']; ?></textarea>
			</div>
